...
class FeedCell: UICollectionViewCell {
    ...
    var descpAtt : NSMutableAttributedString = {
       let name = NSMutableAttributedString()
        return name
    }()
    let descp : UILabel = {
    ...
    private func configureCell(){
        ...
        addSubview(price)
        price.anchor(top: nil, left: nil, bottom: nil, rigth: rightAnchor, marginTop: 0, marginLeft: 12, marginBottom: 0, marginRigth: 0, width: 0, heigth: 0)
        price.centerYAnchor.constraint(equalTo: logo.centerYAnchor).isActive = true
        addSubview(carBrand)
        carBrand.anchor(top: nil, left: logo.rightAnchor, bottom: nil, rigth: price.leftAnchor, marginTop: 0, marginLeft: 12, marginBottom: 0, marginRigth: 12, width: 0, heigth: 0)
        carBrand.centerYAnchor.constraint(equalTo: logo.centerYAnchor).isActive = true
        addSubview(imageSlider)
      
        addSubview(descp)
        addSubview(time)
        time.anchor(top: descp.bottomAnchor, left: leftAnchor, bottom: nil, rigth: rightAnchor, marginTop: 0, marginLeft: 12, marginBottom: 0, marginRigth: 0, width: 0, heigth: 20)
